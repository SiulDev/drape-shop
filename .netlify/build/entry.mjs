...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "sb_publishable_qZYDPoeiVm8w0PUj-Q2H8A_qLvwvXMe",
			"PUBLIC_SUPABASE_URL": "https://xxhsiqwvbyxahzaompyk.supabase.co",
			"SITE": void 0,
			"SSR": true
		}, {
			OS: "Windows_NT",
...
function createHandler({ notFoundContent }) {
	return async function handler(request, context) {
		...
		if (astroLocalsHeader) {
			if (middlewareSecretHeader !== "0a353a10-2052-42f6-8bc8-a912816af50b") return new Response("Forbidden", { status: 403 });
